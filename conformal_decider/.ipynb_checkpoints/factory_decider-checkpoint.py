import numpy as np
from conformal_decider.base_decider import BaseConformalDecider
...
class FactoryDecider(BaseConformalDecider):
    ...
    def decision_function(self, features, lam):
        ...
        defect_prob = stats.beta(lam * features, features).rvs(1)  # Sample defect probability
        return defect_prob
...
class FactoryDecider2(BaseConformalDecider):
