...
class SceneDataset(Dataset):
    def __init__(self, data, resize, total_len):
        ...
        self.trajectories, self.meta, self.scene_list = split_trajectories_by_scene(data, total_len)
    ...
    def __getitem__(self, idx):
        ...
        return trajectory, meta, scene, self.meta
    
def split_trajectories_by_scene(data, total_len):
    trajectories = []
    meta = []
    scene_list = []
